...
local Addons = _G.AtlasLootMY.Addons
local GetAddon = Addons.GetAddon
local FavAddon = _G.AtlasLootMY.Addons:GetAddon("Favourites")
local Sources = _G.AtlasLootMY.Addons:GetAddon("SourcesMY")
...
local function CreateSourceOptions()
    ...
    local t = {
        ...
        set = function(info, value) Sources.db[info[#info]] = value Addons:UpdateStatus("SourcesMY") end,
        args = {
            enabled = {
                order = 1,
                type = "toggle",
                width = "full",
                name = _G.ENABLE,
                desc = format(AL["This loads the |cff999999%s|r module."], "AtlasLootMY_Data")
            },
            showDropRate = {
                order = 2,
                type = "toggle",
                ...
                desc = format(AL["This loads the |cff999999%s|r module."], "AtlasLootMY_DungeonsAndRaids")
            },
            showProfRank = {
                order = 3,
                type = "toggle",
            ...
            typeSelection = {
                ...
                set = function(info, value) Sources.db["Sources"][tonumber(info[#info])] = value Addons:UpdateStatus("SourcesMY") end,
                args = {},
            },
        }
    }
