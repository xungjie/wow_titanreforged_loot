...
local CommandList = {
	...
	["options"] = function()
		showOptions()
		--AtlasLoot.Loader:LoadModule("AtlasLootMY_Options", showOptions)
	end,
	["slash"] = function()
...
function SlashCommands.Init()
	SLASH_ATLASLOOTMY1 = "/atlasloot"
	SLASH_ATLASLOOTMY2 = "/almy"
	SLASH_ATLASLOOTMY3 = "/al"
	SlashCmdList["ATLASLOOTMY"] = function(msg)
		msg = str_lower(msg)
