...
local PRICE_INFO_LIST = {
    ...
    ["TitanEmber"] = { currencyID=3403 },
    ["TitanShard"] = { currencyID=3406 },
...
function VendorPrice.ScanShownVendor()
    ...
    if not SourcesAddon then SourcesAddon = AtlasLoot.Addons:GetAddon("SourcesMY") end
