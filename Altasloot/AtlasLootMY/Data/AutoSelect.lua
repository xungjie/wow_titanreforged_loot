...
function AutoSelect:RefreshOptions()
	if AtlasLoot.db.enableAutoSelect and not AtlasLoot.Loader:IsModuleLoaded("AtlasLootMY_DungeonsAndRaids") then
		AtlasLoot.Loader:LoadModule("AtlasLootMY_DungeonsAndRaids")
	end
end
